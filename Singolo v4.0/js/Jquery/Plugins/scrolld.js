(function ($) {
    $.fn.scrolld = function (options) {
        var scrolldCustom = -2; // Set 'scrolldCustom' value here | Additional distance (+-) on scrolldTop & scrolldPre  
